    ...
    return (
        <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end space-y-3">
            ...
            <button 
                ...
                className="p-3 rounded-full bg-white dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors shadow-xl border border-gray-200 dark:border-gray-600"
                title="切换主题"
            >
